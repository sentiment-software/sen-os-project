...
GDT32_DESC_SIZE equ 0x8
GDT32_DESC_END  equ GDT32_DESC_BASE + GDT32_DESC_SIZE - 1 ; 0x2307
; -- GDT-64 Descriptor
GDT64_DESC_BASE equ 0x2308
GDT64_DESC_SIZE equ 0x8
GDT64_DESC_END  equ GDT64_DESC_BASE + GDT64_DESC_SIZE - 1 ; 0x230F
; -- IDT-64 Descriptor
IDT64_DESC_BASE equ 0x2310
IDT64_DESC_SIZE equ 0x10
IDT64_DESC_END  equ IDT64_DESC_BASE + IDT64_DESC_SIZE - 1 ; 0x231F
; -- Boot Info
BOOT_INFO_BASE  equ 0x2320
BOOT_INFO_SIZE  equ 0x400
BOOT_INFO_END   equ BOOT_INFO_BASE + BOOT_INFO_SIZE - 1 ; 0x271F
; --
; Unallocated glob section: 0x2720 - 0x2FFF
; --
; ----- IDT (64-bit) -----
IDT_BASE        equ 0x3000
IDT_SIZE        equ 0x1000
